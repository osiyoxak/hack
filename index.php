<?php
ob_start();
define('API_KEY', '1200607249:AAGUmPzQNEaNjTnpM4HLmL2L6xCo6YrB3Ek');
//tokenni yozing
$admin = "834522122";
$admins = ["834522122","834522122"];
...
[['text'=>"🔰Statistika🔰"],['text' =>"⚒️Ozgarishla⚒️" ]],
]
])
]); 
} 
...
if($text =="📄Hatolar va fikirlar📄" ){
    bot('sendMessage',[
        'chat_id'=>$chat_id,
'parse_mode'=>'markdown',
        'text'=>"Botga fikirlariz yo xatolarini topgan bosangiz @UzBeK_o7 ga murojat qiling", 
    ]);
}
...
Для этого отправьте @UzBeK_o7 ку ваши пожелания", 
    ]);
}
//fest
if($text =="✨Mans & Girls✨" ){
...
'caption'=>"Sport logotip by @iLogosbot
You write $ex[1]",
]);
} 
...
'caption'=>"Best logotip by @iLogosbot
You write $ex[1]",
]);
} 
...
'caption'=>"Epic logotip by @iLogosbot
You write $ex[1]",
]);
}
...
'caption'=>"Crazy logotip by @iLogosbot
You write $ex[1]",
]);
}
...
'caption'=>"Music logotip by @iLogosbot
You write $ex[1]",
]);
}
...
'caption'=>"game logotip by @iLogosbot
You write $ex[1]",
]);
}
...
'caption'=>"men logotip by @iLogosbot
You write $ex[1]",
]);
}
...
'caption'=>"girl logotip by @iLogosbot
You write $ex[1]",
]);
}
...
'caption'=>"Fest logotip by @iLogosbot
You write $ex[1]",
]);
}
...
'caption'=>"moto logotip by @iLogosbot
You write $ex[1]",
]);
}
...
'caption'=>"Cars logotip by @iLogosbot
You write $ex[1]",
]);
}
...
'caption'=>"DJ logotip by @iLogosbot
You write $ex[1]",
]);
}
